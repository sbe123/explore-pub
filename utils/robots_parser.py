'''
Adopted from here: https://github.com/python/cpython/blob/9912b3d989b0cb442e9f9d55fbdd30d55591e2fc/Lib/urllib/robotparser.py#L233
'''
...
class RobotFileParser:
    ...
    Here, url is the url to the robots.txt file
    """
    ...
    def get_robots_text(self):
        ...
        if resp.status_code == 200:
            ...
            self.parse(resp.text.split('\n'))

        else:

            print('\n################################')
            print('#ERROR with robots.txt request...')
            print('\################################\n')

            print(f'tGET request sent to: {self.url}')
